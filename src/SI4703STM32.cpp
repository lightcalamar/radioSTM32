...
#include <radioSTM32.h>    // Include the common radio library interface
#include <SI4703STM32.h>
...
// int STATUS_LED = 13;
#define resetPin PB11                 // DEFINICION RESET PIN PB11 STM32F103C8T6   28/07/2017
// SDA/A4 on Arduino
#define SDAIO PB7                     // DEFINICION PIN PB7 SDA STM32F103C8T6      28/07/2017
...
bool SI4703::init() {
  ...
  pinMode(SDAIO, OUTPUT); //SDIO is connected to A4 for I2C
  digitalWrite(SDAIO, LOW); //A low SDIO indicates a 2-wire interface
